...
-->
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="linux_390-64_cmprssptrs_zt">
	<name>Linux S390 64bit Compressed Pointers zArtemis</name>
	...
	<owners>
		<owner>vsebe@ca.ibm.com</owner>
	</owners>
	<properties>
		<property name="SE6_extension" value="tar.gz"/>
		<property name="SE6_package" value="xzt64"/>
		...
		<property name="graph_label.java8" value="pxzt64cmprssptrs80"/>
		<property name="graph_label.java9" value="pxzt64cmprssptrs90"/>
		...
		<property name="graph_req.arch0" value="arch:zartemis"/>
		...
		<property name="javatestPlatform" value="linux_390-64_cr_zt"/>
		...
		<property name="main_shortname" value="xzt64"/>
